...
const WORLD_W    = 18000;            // total level width
...
const LEVEL: [number, OType, number][] = [
  ...
  [  800, 's', 1], [ 1160, 's', 1], [ 1520, 's', 1], [ 1940, 's', 1], [ 2360, 's', 1],
  // ── double spikes ──
  [ 2800, 's', 2], [ 3220, 's', 1], [ 3580, 's', 2], [ 3950, 's', 1], [ 4320, 's', 2],
  // ── block obstacles + mixed ──
  [ 4750, 'b', 1], [ 5080, 's', 1], [ 5360, 's', 2],
  [ 5800, 'b', 2], [ 6220, 's', 1], [ 6580, 's', 3],
  [ 7020, 'b', 1], [ 7380, 's', 1], [ 7700, 's', 2],
  // ── triple spikes ──
  [ 8080, 's', 3], [ 8530, 's', 2], [ 8890, 's', 3],
  [ 9280, 'b', 2], [ 9680, 's', 3], [10040, 's', 1], [10340, 's', 3],
  // ── intense section ──
  [10720, 's', 2], [11080, 's', 3], [11550, 's', 2], [11860, 's', 3],
  [12260, 'b', 1], [12600, 's', 3], [12950, 's', 2], [13310, 's', 3],
  // ── final stretch ──
  [13700, 's', 3], [14080, 's', 2], [14440, 's', 3],
  [14830, 's', 3], [15180, 's', 2], [15580, 's', 3],
