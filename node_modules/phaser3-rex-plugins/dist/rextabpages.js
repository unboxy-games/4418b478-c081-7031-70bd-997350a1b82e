(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rextabpages = factory());
    ...
    */
    ...
    var methods$c = {};
    Object.assign(methods$c, ScaleMethods);

    methods$c.onInitScale = function () {
    ...
    var methods$b = {};
    Object.assign(methods$b, FadeMethods);

    methods$b.onInitFade = function () {
    ...
    var methods$a = {};
    Object.assign(methods$a, EaseMoveMethods);

    methods$a.onInitEaseMove = function () {
    ...
    */
    ...
    var Sum = function () {
        return Array.prototype.reduce.call(arguments, Add$7, 0);
    };

    var Add$7 = function (a, b) {
        return a + b;
    };
    ...
    var Add$6 = function (gameObject, columnIndex, rowIndex, align, paddingConfig, expand, childKey) {
        var offsetX, offsetY;
        ...
        if (IsPlainObject$8(columnIndex)) {
            ...
            columnIndex = GetValue$e(config, 'column', undefined);
            rowIndex = GetValue$e(config, 'row', undefined);
            align = GetValue$e(config, 'align', ALIGN_CENTER$3);
        ...
        if (IsPlainObject$8(expand)) {
            config.expandWidth = GetValue$e(expand, 'width', false);
            config.expandHeight = GetValue$e(expand, 'height', false);
        } else {
    ...
    class GridSizer extends Base {
        constructor(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
            if (IsPlainObject$7(x)) {
                ...
                columnCount = GetValue$c(config, 'column', (config.col || 0));
                rowCount = GetValue$c(config, 'row', 0);
                columnProportions = GetValue$c(config, 'columnProportions', 0);
                rowProportions = GetValue$c(config, 'rowProportions', 0);
            ...
            this.setCreateCellContainerCallback(GetValue$c(config, 'createCellContainerCallback'));

            this.setIndentLeft(
                GetValue$c(config, 'space.indentLeftOdd', 0),
                GetValue$c(config, 'space.indentLeftEven', 0)
            );
            this.setIndentTop(
                GetValue$c(config, 'space.indentTopOdd', 0),
                GetValue$c(config, 'space.indentTopEven', 0)
            );
    ...
    var AddChildMethods$5 = {
        ...
        insertSpace(index, proportion) {
            ...
            Add$5.call(this, new Space(this.scene),
                {
    ...
    let Buttons$1 = class Buttons extends Sizer {
        constructor(scene, config) {
            ...
            this.buttonGroup = new ButtonGroup({
                parent: this,
                eventEmitter: GetValue$8(config, 'eventEmitter', this),
            ...
            // Buttons properties
            this.buttonsExpand = GetValue$8(config, 'expand', false);
            this.buttonsAlign = GetValue$8(config, 'align', undefined); // undefined/left/top: no space                
    ...
    class FixWidthSizer extends Base {
        constructor(scene, x, y, minWidth, minHeight, config) {
            ...
            this.setIntentLeft(
                GetValue$6(config, 'space.indentLeftOdd', 0),
                GetValue$6(config, 'space.indentLeftEven', 0)
            );
            this.setIntentTop(
                GetValue$6(config, 'space.indentTopOdd', 0),
                GetValue$6(config, 'space.indentTopEven', 0)
            );
            this.setAlign(GetValue$6(config, 'align', 0));
            this.setJustifyPercentage(GetValue$6(config, 'justifyPercentage', 0.25));
    ...
    class Buttons extends FixWidthSizer {
        constructor(scene, config) {
            ...
            this.buttonGroup = new ButtonGroup({
                parent: this,
                eventEmitter: GetValue$5(config, 'eventEmitter', this),
            ...
            // Buttons properties
            this.buttonsAlign = GetValue$5(config, 'align', undefined);
    ...
    class Pages extends OverlapSizer {
        constructor(scene, config) {
            ...
            this.setSwapMode(GetValue$2(config, 'swapMode', 0));
            this.setFadeInDuration(GetValue$2(config, 'fadeIn', 0));
        }
    ...
    var AddPage = function (key, tabGameObject, pageGameObject) {
        if (IsPlainObject(key)) {
            ...
            tabGameObject = GetValue$1(config, 'tab');
            pageGameObject = GetValue$1(config, 'page');
        }
