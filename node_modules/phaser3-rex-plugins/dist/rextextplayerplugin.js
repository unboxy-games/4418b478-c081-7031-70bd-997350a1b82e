(function (global, factory) {
    ...
    var DrawBounds = function (gameObjects, graphics, config) {
        ...
        if (typeof (config) === 'number') {
            ...
            fillAlpha = GetValue$v(config, 'fillAlpha');
            padding = GetValue$v(config, 'padding');
            includeParent = GetValue$v(config, 'includeParent');
        }
    ...
    class Fade extends EaseValueTaskBase {
        ...
        resetFromJSON(o) {
            ...
            this.setVolumeRange(
                GetAdvancedValue$1(o, 'volume.start', this.parent.volume),
                GetAdvancedValue$1(o, 'volume.end', 0)
            );
            return this;
        }
    ...
    var GetValue$f = function (source, key, defaultValue, altSource) {
