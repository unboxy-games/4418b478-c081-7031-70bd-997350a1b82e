(function (global, factory) {
    ...
    */
    ...
    var Add$5 = function (gameObject, childKey, align, padding, expand, minWidth, minHeight, offsetX, offsetY, aspectRatio) {
        var offsetOriginX, offsetOriginY;
        ...
        if (IsPlainObject$5(childKey)) {
            ...
            aspectRatio = GetValue$b(config, 'aspectRatio', 0);
        }
    ...
    var ResetGrid = function (
        ...
        // space
        this.setColumnSpace(GetValue$3(space, 'column', 0));
        this.setRowSpace(GetValue$3(space, 'row', 0));
    ...
    class GridSizer extends Base {
        constructor(scene, x, y, minWidth, minHeight, columnCount, rowCount, columnProportions, rowProportions, config) {
            ...
            this.sizerChildren = [];
            this.addChildrenMap('items', this.sizerChildren);
            this.setCreateCellContainerCallback(GetValue$2(config, 'createCellContainerCallback'));
            ...
            this.resetGrid(
                columnCount, rowCount,
                columnProportions, rowProportions,
                GetValue$2(config, 'space', undefined)
            );
