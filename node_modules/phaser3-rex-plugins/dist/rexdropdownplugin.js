    ...
    */
    ...
    class OpenCloseTransition extends ComponentBase {
        constructor(gameObject, config) {
            ...
            this.setTransitInTime(GetValue$7(config, 'duration.in', 200));
            this.setTransitOutTime(GetValue$7(config, 'duration.out', 200));
            this.setTransitInCallback(GetValue$7(config, 'transitIn'));
            this.setTransitOutCallback(GetValue$7(config, 'transitOut'));

            this.oneShotMode = GetValue$7(config, 'destroy', false);
    ...
    var SetPosition = function (gameObject, config) {
        ...
        var alignSide = GetValue$1(config, 'alignSide', '');
