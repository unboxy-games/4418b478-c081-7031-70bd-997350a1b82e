(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexfileselectorbutton = factory());
    ...
    */
    ...
    var FontSizeExpandText = function (textObject, config) {
        ...
        var minWidth = GetValue$3(config, 'minWidth', 0);
        var minHeight = GetValue$3(config, 'minHeight', 0);
    ...
    class Label extends LabelBase {
        constructor(scene, config) {
            ...
            var icon = GetValue$2(config, 'icon', undefined);
            var iconMask = GetValue$2(config, 'iconMask', undefined);
            var text = GetValue$2(config, 'text', undefined);
            var action = GetValue$2(config, 'action', undefined);
            var actionMask = GetValue$2(config, 'actionMask', undefined);
            // Align
            var align = GetValue$2(config, 'align', undefined); // undefined/left/top: no space
            ...
            if (icon) {
                ...
                if (!fitRatio) {
                    var iconSize = GetValue$2(config, 'iconSize', undefined);
                    this.setIconSize(
                        GetValue$2(config, 'iconWidth', iconSize),
                        GetValue$2(config, 'iconHeight', iconSize)
                    );
                }
            }
            ...
            if (text) {
                ...
                var adjustTextFontSize = GetValue$2(config, 'adjustTextFontSize', false);
                if (wrapText) {
                    if (wrapText === true) {
                        wrapText = 'word';
                    }
                ...
                var textSpace = GetValue$2(config, 'space.text', 0);
                var expandTextWidth = GetValue$2(config, 'expandTextWidth', false);
                var expandTextHeight = GetValue$2(config, 'expandTextHeight', false);
            ...
            if (action) {
                ...
                if (!fitRatio) {
                    var actionSize = GetValue$2(config, 'actionSize');
                    this.setActionSize(
                        GetValue$2(config, 'actionWidth', actionSize),
                        GetValue$2(config, 'actionHeight', actionSize)
                    );
                }
            }
    ...
    class FileChooser extends DOMElement {
        constructor(scene, x, y, width, height, config) {
            ...
            this.setCloseDelay(GetValue$1(config, 'closeDelay', 200));
        ...
        resetFromJSON(config) {
            this.setAccept(GetValue$1(config, 'accept', ''));
            this.setMultiple(GetValue$1(config, 'multiple', false));
            return this;
        }
