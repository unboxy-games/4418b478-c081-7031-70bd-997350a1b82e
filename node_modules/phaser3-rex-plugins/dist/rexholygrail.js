(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.rexholygrail = factory());
    ...
    */
    ...
    var GetAddChildConfig = function (config, key, defaultValues) {
        var proportion = GetValue$1(config, `proportion.${key}`, defaultValues.proportion);
        var align = GetValue$1(config, `align.${key}`, 'center');
        var padding = GetValue$1(config, `space.${key}`, undefined);
        if ((typeof (padding) === 'number') && defaultValues.paddingKey) {
            var paddingNum = padding;
            padding = {};
            padding[defaultValues.paddingKey] = paddingNum;
        }
        var expand = GetValue$1(config, `expand.${key}`, true);
