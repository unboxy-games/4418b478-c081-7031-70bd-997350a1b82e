    ...
    */
    ...
    class Background extends RenderBase {
        constructor(parent, config) {
            ...
            this.setCornerRadius(
                GetValue$b(config, 'cornerRadius', 0),
                GetValue$b(config, 'cornerIteration', null)
            );
        }
    ...
    class InnerBounds extends RenderBase {
        ...
        modifyPorperties(o) {
            ...
            if (o.hasOwnProperty('color')) {
                this.setColor(
                    o.color,
                    GetValue$a(o, 'color2', null),
                    GetValue$a(o, 'horizontalGradient', true)
                );
            }
            if (o.hasOwnProperty('stroke')) {
                this.setStroke(
                    o.stroke,
                    GetValue$a(o, 'strokeThickness', 2)
                );
            }
        }
    ...
    class TextStyle {
        ...
        set(o) {
            ...
            this.setStrokeStyle(
                GetValue$9(o, 'stroke', null),
                GetValue$9(o, 'strokeThickness', 0)
            );
            this.setShadow(
                GetValue$9(o, 'shadowColor', null),
                GetValue$9(o, 'shadowOffsetX', 0),
                GetValue$9(o, 'shadowOffsetY', 0),
                GetValue$9(o, 'shadowBlur', 0)
            );
            this.setOffset(
                GetValue$9(o, 'offsetX', 0),
                GetValue$9(o, 'offsetY', 0)
            );
            this.setSpace(
                GetValue$9(o, 'leftSpace', 0),
                GetValue$9(o, 'rightSpace', 0)
            );
            ...
            this.setBackgroundLeftX(GetValue$9(o, 'backgroundLeftX', 0));
            this.setBackgroundRightX(GetValue$9(o, 'backgroundRightX', 0));
    ...
    var RunWordWrap$1 = function (config) {
        ...
        if (lineHeight === undefined) {
            ...
            var useDefaultTextHeight = GetValue$8(config, 'useDefaultTextHeight', false);
        ...
        var wrapMode = GetValue$8(config, 'wrapMode');
        ...
        var justifyPercentage = GetValue$8(config, 'justifyPercentage', 0.25);
    ...
    var RunVerticalWrap$1 = function (config) {
        ...
        var fixedCharacterHeight = GetValue$7(config, 'fixedCharacterHeight', undefined);
    ...
    class DynamicText extends Canvas {
        constructor(scene, x, y, fixedWidth, fixedHeight, resolution, config) {
            if (IsPlainObject(x)) {
                ...
                resolution = GetValue$5(config, 'resolution', 1);
            ...
            this.setTestString(GetValue$5(config, 'testString', '|MÉqgy'));

            this._textOX = 0;
            this._textOY = 0;
            this.background = new Background(this, GetValue$5(config, 'background', undefined));
            this.innerBounds = new InnerBounds(this, GetValue$5(config, 'innerBounds', undefined));
            this.children = [];
            ...
            this.setPadding(GetValue$5(config, 'padding', 0));
            this.setWrapConfig(GetValue$5(config, 'wrap', undefined));
            this.setChildrenInteractiveEnable(GetValue$5(config, 'childrenInteractive', false));
    ...
    var FontSizeExpandText = function (textObject, config) {
        ...
        var minWidth = GetValue$4(config, 'minWidth', 0);
        var minHeight = GetValue$4(config, 'minHeight', 0);
        var fitHeight = GetValue$4(config, 'fitHeight', false);
        ...
        constructor(scene, config) {
            ...
            if (icon) {
                ...
                if (!fitRatio) {
                    ...
                    this.setIconSize(
                        GetValue$3(config, 'iconWidth', iconSize),
                        GetValue$3(config, 'iconHeight', iconSize)
                    );
                }
            }
            ...
            if (text) {
                var wrapText = GetValue$3(config, 'wrapText', false);
                var adjustTextFontSize = GetValue$3(config, 'adjustTextFontSize', false);
                if (wrapText) {
                    if (wrapText === true) {
                        wrapText = 'word';
                    }
            ...
            if (action) {
                ...
                if (!fitRatio) {
                    ...
                    this.setActionSize(
                        GetValue$3(config, 'actionWidth', actionSize),
                        GetValue$3(config, 'actionHeight', actionSize)
                    );
                }
            }
    ...
    var RunCommands = function (queue, scope, config) {
        var reverse = GetValue$C(config, 'reverse', false);
    ...
    var RunCommand = function (cmd, scope, config) {
        var argsConvert = GetValue$C(config, 'argsConvert', undefined);
        var argsConvertScope = GetValue$C(config, 'argsConvertScope', undefined);
        ...
        if (typeof (fnName) === 'string') {
            fn = scope[fnName];
            if (fn == null) {
                fn = GetValue$C(scope, fnName, null);
            }
        } else {
            fn = fnName;
        }
